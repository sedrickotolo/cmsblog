<?php function showOption($data, $parent, $id, $level) { ?>
    <?php foreach ($data as $t): ?>
        ...
        <?php if(isset($t['children'])): ?>
            <?php showOption($t['children'], $parent, $id, $level + 3) ?>
        <?php endif ?>
    <?php endforeach ?>
<?php } ?>
            ...
            <form id="gallery-form-edit">
                <div class="tab-content">
                        ...
                        <table class="table table-custom">
                                ...
                                <td class="col-md-6">
                                    <select id="parent" name="parent" data-live-search="true" class="form-control form-control-custom selectpicker show-tick">
                                        ...
                                        <?php if(!empty($data['pages'])): ?>
                                            <?php showOption($data['pages'], $data['data']['parent'], $data['data']['id'] , 0) ?>
                                        <?php endif ?>
                                    </select>
                                </td>
                            </tr>
                            ...
                            <tr class="form-group">
                                <td class="col-md-6">
                                    ...
                                    <p class="help-block">If not checked, the page and its descendants will not be displayed on the site</p>
                                </td>
                                <td class="col-md-6">
                    ...
                    <div role="tabpanel" class="tab-pane" id="images-tab">
                        <div class="img-zone text-center" id="gallery-drag-zone">
                            <div class="img-drop">
                                <div class="inline-text"><img src="/admin/public/img/drag-and-drop.png" alt=""></span></div>
                                <span class="btn btn-default gallery-btn-images-upload btn-file">Open file manager<input type="file" multiple="" accept="image/*" class="input-file"></span>
                            </div>
                        </div>
                        <div class="progress gallery-progress-images hidden">
                        ...
                        <div class="row gallery-images-preview">
                            <?php if(!empty($data['data']['images'])): ?>
                                <?php foreach($data['data']['images'] as $t): ?>
                                    <div class="col-md-6">
                                        <div class="gallery-image-item thumbnail action-btn">
                                            <img src="/files/images/thumbnail/<?php echo $t['image'] ?>" alt="" style="height: 300pt; width: 100%">
                                            <input value="<?php echo $t['title'] ?>" placeholder="Headline" class="form-control image-title">
                                            <textarea placeholder="Text" class="form-control image-text" style="resize:vertical"><?php echo $t['text'] ?></textarea>
                                            <input type="file" accept="image/*" class="hidden image-file">
                                            <div class="gallery-image-replace" data-toggle="tooltip" data-placement="top" title="Replace image">
                                                <span class="fa fa-picture-o"></span>
                                            </div>
                                            <div class="gallery-image-delete" data-toggle="tooltip" data-placement="top" title="Delete">
                        ...
                        <div class="gallery-image-item-html hidden">
                            <div class="col-md-6">
                                <div class="gallery-image-item thumbnail action-btn">
                                    <img src="" alt="" style="height: 300pt; width: 100%">
                                    <input value="" placeholder="Headline" class="form-control image-title">
                                    <textarea placeholder="Text" class="form-control image-text" style="resize:vertical"></textarea>
                                    <input type="file" accept="image/*" class="hidden image-file">
                                    <div class="gallery-image-replace" data-toggle="tooltip" data-placement="top" title="Replace image">
                                        <span class="fa fa-picture-o"></span>
                                    </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="form-tab">
                        ...
                        <div class="form-container well well-sm" data-json='<?php echo json_encode($data['data']['form']) ?>'></div>

            ...
            <form id="gallery-form-add">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="main-tab">
                        <table class="table table-custom">
                            ...
                            <tr class="form-group">
                                ...
                                <td class="col-md-6">
                                    <div class="input-group">
                                        <input id="icon" name="icon" type="text" value="fa-image" data-placement="bottomRight" class="form-control form-control-custom icp icp-auto"/>
                            ...
                            <tr class="form-group">
                                ...
                                <td class="col-md-6">
                                    <input id="url" name="url" value="" type="text" placeholder="Page URL" class="form-control form-control-custom translit-out"/>
                                </td>
                            </tr>
                            <tr class="form-group">
                                <td class="col-md-6">
                    ...
                    <div role="tabpanel" class="tab-pane" id="images-tab">
                        ...
                        <div class="row gallery-images-preview"></div>

<aside class="control-sidebar control-sidebar-dark">
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs" style="padding-top: 15px">
        <li>
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="control-sidebar-theme-options-tab">
            <div>
                <h4 class="control-sidebar-heading">Design Settings</h4>
                <h4 class="control-sidebar-heading">Themes</h4>

<?php function showOption($data, $level) { ?>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="main-tab">
                        <table class="table table-custom">
                            <tr class="form-group">
                                ...
                                <td class="col-md-6">
                                    <?php if(!empty($data['category'])): ?>
                                        <select id="category" name="category[]" data-live-search="true" multiple class="form-control form-control-custom selectpicker show-tick">
                                    ...
                                    <?php if(!empty($data['tags'])): ?>
                                        <select id="tags" name="tags[]" data-live-search="true" multiple class="form-control form-control-custom selectpicker show-tick">
                                            <?php foreach ($data['tags'] as $t): ?>
                                                <option value="<?php echo $t['id'] ?>" data-icon="fa-tag">
                                                    <?php echo $t['name'] ?>
                                                </option>
                                            <?php endforeach ?>
                                        </select>
                            ...
                            <tr class="form-group">
                                ...
                                <td class="col-md-6">
                                    <input id="time" name="time" value="<?php echo date('Y-m-d G:i:s') ?>" type="text" placeholder="Publication date" class="form-control form-control-custom date-time-picker"/>
                                </td>
                            </tr>
                            <tr class="form-group">
                                <td class="col-md-6">
                    ...
                    <div role="tabpanel" class="tab-pane" id="meta-tab">
                        <table class="table table-custom">
                            <tr class="form-group">
                                ...
                                <td class="col-md-6">
                                    <input id="title" name="title" value="" type="text" placeholder="Title" class="form-control form-control-custom translit-in input-in"/>
                                </td>
                            </tr>
                            <tr class="form-group">
                                <td class="col-md-6">
                    ...
                    <div role="tabpanel" class="tab-pane" id="content-tab">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="shortentry" name="shortentry" class="form-control form-control-custom editor-content"></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea id="fullentry" name="fullentry" class="form-control form-control-custom editor-content"></textarea>
                        </div>
                    </div>
                            ...
                            <div class="panel-body panel-body-custom" style="margin: 10px">
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input type="radio" name="preview-element" value="images" checked> Images
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="preview-element" value="slider"> Slider
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="preview-element" value="video"> Video
                                    </label>
                                </div>
                            </div>
                        </div>
